...
. **Search** for the catalog entry: **Fast-track Ansible Automation Platform Migration**.
+
...
[[RHDP-Portal-Links]]
=== RHDP Portal Links
- RedHat associates: https://integration.demo.redhat.com/catalog?search=fast&item=babylon-catalog-prod%2Fpert.aap2.4-to-aap2.6-migration.prod[Demo.redhat.com,window=_blank]
- RedHat partners: https://catalog.partner.demo.redhat.com/catalog?search=fast-track&item=babylon-catalog-prod%2Fpartner.aap2.4-to-aap2.6-migration.prod[Partner.demo.redhat.com/,window=_blank]
