...
.. On the Hub node you can run the below command to get the database-related information and add the value of `NAME` variable in `secrets.yml` file at `hub_pg_database` .
+
[source,bash,role=execute]
----
...
.. On the *gateway node* you can run the below command to get the database-related information and add the value of `NAME` variable in `secrets.yml` file at `gateway_pg_database` .
+
[source,bash,role=execute]
----
...
.. Accessing the *controller node* you can run the below command to get the database-related information  and add the value of `NAME` variable in `secrets.yml` file at `controller_pg_database` .
+
[source,bash,role=execute]
----
